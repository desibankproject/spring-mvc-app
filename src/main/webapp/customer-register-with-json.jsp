...
<title>Palindom</title>
  ...
  <script type="text/javascript">
  		...
  		function validateCustomer(){
  				...
  				//Write code to send data in JSON format;;;
  				//We have to write code to read date from html form  and convert into JSON format!
  				 //below line will read all the form data and covert into Array of key value
  				 var jdata=$("#customerform").serializeArray();
			   	 var jsonData = {};
			   	 //Array of key value pair
			   	 //add all key and values into one object 
			    ...
			    var contextPath="${pageContext.request.contextPath}";
			   	//JSON.stringify(jsonData) = stringify - convert JavaScript object into JSON format
			   	$.ajax({url:contextPath+"/ajax-add-csutomer-as-json",contentType: "application/json; charset=utf-8", dataType: "json", type: 'POST',data:JSON.stringify(jsonData),success:function(data) {  //data= this.responseText
