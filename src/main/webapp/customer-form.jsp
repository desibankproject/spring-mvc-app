...
<body>
	...
	<section>
		...
		http://localhost:8080/spring-kb/ check
		 -->	
		<sp:form name="customerform" action="${pageContext.request.contextPath}/sp-register" method="post" commandName="customerVO">
		<h4>${message}</h4>
		<table>
		<tr>
			<tr>
				<td>Username :&nbsp;&nbsp;&nbsp;</td>
				<td>
				<sp:input  type="text" path="username" style="width: 300px;display: inline;margin-right:20px;" class="form-control"  onkeypress="clearText();" onblur="checkName();"/>
			...
			<tr>
				<td>Password :&nbsp;&nbsp;&nbsp;</td>
				<td>
				<sp:input type="password" path="password" style="width: 300px;" class="form-control" onkeypress="clearText();"/>
			...
			<tr>
				<td>Email :&nbsp;&nbsp;&nbsp;</td>
				<td>
				<sp:input type="text" path="email" style="width: 500px;" class="form-control" onkeypress="clearText();"/>
			...
			<tr>
				<td>Role :&nbsp;&nbsp;&nbsp;</td>
				<td>
				<sp:select  path="role" style="width: 300px;" class="form-control">
			...
			<tr>
				...
				<sp:radiobuttons path="gender" items="${genderList}" style="display: inline;margin-left: 20px;" onclick="updateImage(this);"/>
				<%-- <sp:input type="radio" path="gender" value="male"  style="display: inline;" onclick="updateImage('Male');"/> Male
  				<sp:input type="radio" path="gender" value="female" style="display: inline;margin-left: 20px;" onclick="updateImage('Female');"/> Female --%>
				</td>
			</tr>	
			...
			<tr>
				<td>Photo :&nbsp;&nbsp;&nbsp;</td>
				<td>
				<sp:input type="text" path="photo" style="width: 700px;" class="form-control"/>
